...
public class Client implements ClientProtocol{
    ...
    public void createConnection() throws ExitProgram {
        ...
        while (serverSocket == null) {
            ...
            try {
                ...
                TUI.showMessage("Attempting to connect to " + addr + ":" 
                    + port + "...");
	...
	public void createLobby(String lobbyname, int size) throws ServerUnavailableException {
		sendMessage(ProtocolMessages.CREATE + ProtocolMessages.DELIMITER + lobbyname + ProtocolMessages.DELIMITER + size + ProtocolMessages.DELIMITER);
